...
| Application Development | Frontend Development | Integrate new backend services into client UI | 8 |
| | Lead Capture Form | Create form for WorldSafe backend data submission | 2 |
| | Server Development | Upgrade LLM model integration in server application | 10 |
...
| Engineering Subtotal         | $4,875.00     |
| Demo Application Acquisition | $2,500.00     |
| **Total Project Cost**       | **$7,375.00** |

This project builds upon a previously developed prototype. The acquisition cost above ensures Equal Sons holds full ownership and licensing rights over all code delivered in this engagement, with no outstanding claims from prior contributors.

**Payment Schedule:**

- **Demo + 50% Engineering deposit ($4,937.50)** due upon signed proposal to initiate work
- **Remaining Engineering balance ($2,437.50)** due upon project completion and delivery
