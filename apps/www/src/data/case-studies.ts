...
// Helper functions
export const getCaseStudiesByPillar = (pillar: "build" | "lead" | "share"): ICaseStudy[] => {
...
export const getRelatedCaseStudies = (currentStudy: ICaseStudy): ICaseStudy[] => {
	...
	return caseStudies
		.filter((study) => {
			...
			const hasOverlap = study.serviceTags.some((tag) => currentStudy.serviceTags.includes(tag));
